...
silent only
silent tabonly
cd ~/5W/LeetCode_1000/leetcode_cpp/002.Add-Two-Numbers
...
argglobal
%argdel
$argadd ~/.vim/plugged/vim-snippets/UltiSnips-DC/cpp.snippets
edit ~/.vim/plugged/vim-snippets/UltiSnips-DC/cpp.snippets
...
let s:l = 96 - ((13 * winheight(0) + 15) / 30)
...
normal! 0
tabnext 1
badd +0 ~/.vim/plugged/vim-snippets/UltiSnips-DC/cpp.snippets
